      ...
      <footer className="bg-gray-800 text-gray-100 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h3 className="font-heading font-semibold text-lg mb-4 text-white">Oslo Running Calendar</h3>
            ...
            <div>
              <h3 className="font-heading font-semibold text-lg mb-4 text-white">Connect</h3>
